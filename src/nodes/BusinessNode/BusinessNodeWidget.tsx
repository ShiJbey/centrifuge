...
export class BusinessNodeWidget extends React.Component<BusinessNodeWidgetProps> {
    ...
    public render(): React.ReactNode {
        ...
        return (
            <Node
                background={BUSINESS_NODE_COLOR}
            ...
            >
                ...
                <div>
                    <label
                        htmlFor={`businessTypes_${this.props.node.getID()}`}
                    ></label>
                    <select
                        ...
                        onChange={(event) => {
                            this.props.node.getOptions().businessType =
                                event.target.value;
                            this.forceUpdate();
                        }}
                    >
                        <option value="_">Select business type...</option>
                        <option value="ApartmentComplex">
                            Apartment Complex
                        </option>
                        ...
                        <option value="OptometryClinic">
                            Optometry Clinic
                        </option>
                        <option value="PaintingCompany">
                            Painting Company
                        </option>
                        <option value="Park">Park</option>
                        <option value="Pharmacy">Pharmacy</option>
                        <option value="PlasticSurgeryClinic">
                            Plastic Surgery Clinic
                        </option>
                        <option value="PlumbingCompany">
                            Plumbing Company
                        </option>
