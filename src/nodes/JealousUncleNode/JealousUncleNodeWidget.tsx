...
import {
  JealousUncleNodeModel,
} from './JealousUncleNodeModel';
...
const Node = styled.div<{ background: string; selected: boolean }>`
  background-color: ${(p) => p.background ?? JEALOUS_UNCLE_NODE_COLOR};
  border-radius: 5px;
...
export interface JealousUncleNodeWidgetProps {
  node: JealousUncleNodeModel;
  engine: DiagramEngine;
}

export class JealousUncleNodeWidget extends React.Component<JealousUncleNodeWidgetProps> {
  constructor(props: JealousUncleNodeWidgetProps) {
    super(props);
  }
