...
import {
  AsymmetricFriendshipNodeModel,
} from './AsymmetricFriendshipNodeModel';
...
export interface AsymmetricFriendshipNodeWidgetProps {
  node: AsymmetricFriendshipNodeModel;
  engine: DiagramEngine;
}

export class AsymmetricFriendshipNodeWidget extends React.Component<AsymmetricFriendshipNodeWidgetProps> {
  constructor(props: AsymmetricFriendshipNodeWidgetProps) {
    super(props);
  }
