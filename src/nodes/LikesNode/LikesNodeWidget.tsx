...
const Node = styled.div<{ background: string; selected: boolean }>`
  background-color: ${(p) => p.background ?? LIKES_NODE_COLOR};
  border-radius: 5px;
...
export interface LikesNodeWidgetProps {
  node: LikesNodeModel;
  engine: DiagramEngine;
}

export class LikesNodeWidget extends React.Component<LikesNodeWidgetProps> {
  constructor(props: LikesNodeWidgetProps) {
    super(props);
  }
