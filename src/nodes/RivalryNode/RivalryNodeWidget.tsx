...
const Node = styled.div<{ background: string; selected: boolean }>`
  background-color: ${(p) => p.background ?? RIVALRY_NODE_COLOR};
  border-radius: 5px;
...
export interface RivalryNodeWidgetProps {
  node: RivalryNodeModel;
  engine: DiagramEngine;
}

export class RivalryNodeWidget extends React.Component<RivalryNodeWidgetProps> {
  constructor(props: RivalryNodeWidgetProps) {
    super(props);
  }
