...
const Node = styled.div<{ background: string; selected: boolean }>`
  background-color: ${(p) => p.background ?? DISLIKES_NODE_COLOR};
  border-radius: 5px;
...
export interface DislikesNodeWidgetProps {
  node: DislikesNodeModel;
  engine: DiagramEngine;
}

export class DislikesNodeWidget extends React.Component<DislikesNodeWidgetProps> {
  constructor(props: DislikesNodeWidgetProps) {
    super(props);
  }
