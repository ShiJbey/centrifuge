...
import { FaProjectDiagram, FaQuestion } from 'react-icons/fa';
        ...
        <nav className={styles.AppNavbar}>
            <ul className={styles.AppNavbarNav}>
                {nav_links.map((linkInfo, index) => (
                    <li
                        key={`${index}_${linkInfo.router_link}`}
                    ...
                    >
                        <OverlayTrigger
                            ...
                            overlay={(props: any) => (
                                <Tooltip {...props}>{linkInfo.tooltip}</Tooltip>
                            )}
                        >
                            <Link
                            ...
                            >
                                ...
                                <IconContext.Provider
                                    value={{ className: styles.NavIcon }}
                                >
                                    {linkInfo.icon}
                                </IconContext.Provider>
                            </Link>
