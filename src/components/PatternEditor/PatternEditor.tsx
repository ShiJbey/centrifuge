...
import {
  compilePattern,
  toQueryString,
} from "../../utility/patternCompiler/patternCompiler";
...
> {
  ...
  compilePattern(): string {
    ...
    const pattern = compilePattern(
      activeEditor.app.getActiveDiagram().serialize()
    );
    return toQueryString(pattern);
  }
      ...
      <>
        ...
        <div className={styles.Container}>
          ...
          <div className={styles.PatternEditorContainer}>
                        ...
                        >
                          <EditorWidget
                            ...
                            onUpdate={(data: any) => {
                              ...
                              this.setState({
                                ...this.state,
                                currentCode: this.compilePattern(),
                              });
                            }}
                          />
                        </Tab.Pane>
            ...
            <EditorPanel>
              <div style={{ padding: "0.5rem", height: "13rem" }}>
